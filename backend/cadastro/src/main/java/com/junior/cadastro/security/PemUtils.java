...
public class PemUtils {
	...
	// Lê um arquivo PEM, extrai o conteúdo Base64 entre BEGIN/END e retorna os bytes decodificados da chave.
	 public static byte[] readPemBlock(Resource pem, String type) throws IOException {
